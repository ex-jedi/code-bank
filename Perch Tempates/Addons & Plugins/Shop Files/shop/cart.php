...
<h1 class="main-heading"><a href="/"><?php perch_content('Sitewide Main Heading'); ?></a></h1>
		...
		<main class="main-content cart-page">
		  <?php perch_shop_cart(); ?>
			...
			<div class="cart-next-step-div" id="cart-next-step-div">
				<div class="cart-progress-div">
						<a class="cart-continue-shopping-link" href="/shop/">Continue shopping</a>
						<a class="cart-checkout-link" href="registration.php">Checkout</a>
				</div>
				<?php if(perch_member_logged_in()){ ?>
			 <a class="cart-logout-link" href="/shop/logout.php">Log out and clear cart</a>
				<?php } ?>
			</div>
			<div class="cart-notes">
				<?php perch_content('Cart Page Notes'); ?>
			</div>
		</main> <!-- main content -->
